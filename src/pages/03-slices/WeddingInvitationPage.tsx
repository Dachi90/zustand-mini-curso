...
export const WeddingInvitationPage = () => {
	...
	const setFirstName = useWeddingBoundStore((state) => state.setFirstNanme);
	const setLastName = useWeddingBoundStore((state) => state.setLastNanme);
	...
	const isConfrimed = useWeddingBoundStore((state) => state.isConfirmed);
	...
	const onSubmit = (e: FormEvent<HTMLFormElement>) => {
		e.preventDefault();
		console.log({ firstName, lastName, guestCount, eventDate, isConfrimed });
	};
